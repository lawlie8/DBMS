...
if (strtotime($date) > $now) {
  ...
  $s = $_SESSION['email'];
  $sql = "INSERT into login_table (email,flight_id,flight_name,from_airport,to_airport,departure,arrival,duration,date)" ."values ('$s',23015,'Russian Airlines','Mumbai','Moscow','14:00:00','20:50:00',7,'$date')";
