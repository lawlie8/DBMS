...
<div class="left_countries_container">
  ...
  <div class="europe">
    <li><button  id=eur0 onclick='window.location.replace("flights_europe.php")' ondblclick="europe_no()" type="button" name="button">Europe</button></li>
  ...
  <div class="middle_east">
        <li onclick="window.location.replace('flights_middle_east.php')"> <button id=mid0 ondblclick="middle_no()" onclick="middle()">MiddleEast</button></li>
  ...
  <div class="africa">
    <li onclick="window.location.replace"><button id=afr0 type="button" name="button" onclick="africa()" ondblclick ="africa_no()">Africa</button></li>
