            ...
            <form method=post action=payment_of_flight90966.php>
            <table>
            <tr>
...
if (strlen($credit_card_no) == 16){
  $sql = "update login_table set payment = 'paid' where email='$s' and  flight_id =90966" ;
    $us_result = $conn->query($sql);
header('location: ../bookflight90966.php');
    }?>
